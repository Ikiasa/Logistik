...
\set default_tenant_id '00000000-0000-0000-0000-000000000000'
...
ALTER TABLE order_adjustments ADD COLUMN tenant_id UUID;
...
UPDATE order_adjustments SET tenant_id = :'default_tenant_id' WHERE tenant_id IS NULL;
UPDATE outbox_events SET tenant_id = :'default_tenant_id' WHERE tenant_id IS NULL;
...
CREATE INDEX idx_orders_tenant_composite ON orders(tenant_id, id);
CREATE INDEX idx_order_items_tenant_composite ON order_items(tenant_id, id);
CREATE INDEX idx_ledger_tenant_composite ON order_adjustments(tenant_id, id);
CREATE INDEX idx_outbox_tenant_composite ON outbox_events(tenant_id, id);
